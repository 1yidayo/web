    ...
    <div class="wrapper">
        <div class="nav">
            <div class="sidebar">
                ...
                <ul><a href="儀器預約現況.html"><img class="img" src="https://cdn4.iconfinder.com/data/icons/user-interface-937/24/20.clock_time_watch_date_ui-64.png"> 預約儀器使用</img></a></ul>
                <ul><a href="繳費系統.html"><img class="img" src="https://cdn2.iconfinder.com/data/icons/legal-services-icostory-black-and-white/64/button-legal_document-list-goals-checklist-64.png"> 繳費系統</img></a></ul>
        ...
        <div class="main">
            <div></div>
            <div class="payment" style="margin-left:30%;margin-top: 40px;margin-bottom: 40px;">
                <div class="payment-container">
                    ...
                    <form id="paymentForm">
                        <div class="form-group">
                            ...
                            <div class="error-message" id="cardNumberError">此為必填欄位</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="error-message" id="cardNameError">此為必填欄位</div>
                        </div>
                        <div class="form-group">
                            <label for="expiryDate">有效期限</label>
                            <input type="text" id="expiryDate" name="expiryDate" placeholder="MM/YY" required>
                            <div class="error-message" id="expiryDateError">此為必填欄位</div>
                        </div>
                        <div class="form-group">
                            <label for="cvv">安全碼 (CVV)</label>
                            <input type="text" id="cvv" name="cvv" maxlength="3" required>
                            <div class="error-message" id="cvvError">此為必填欄位</div>
                        </div>
                        <div class="form-group">
                            <label for="amount">繳費金額</label>
                            <input type="number" id="amount" name="amount" required>
                            <div class="error-message" id="amountError">此為必填欄位</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="error-message" id="currencyError">此為必填欄位</div>
                        </div>
                        <button type="submit" class="button">繳費</button>
                    </form>
                    <div class="popup-wrap" id="paymentSuccessPopup">
                        <div class="popup-box transform-out">
                            <h2 class="h2">繳費成功</h2>
                            <h3 class="h3">您的付款已成功處理。</h3>
