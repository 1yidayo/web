    ...
    <div class="wrapper">
        <div class="nav">
            <div class="sidebar">
                ...
                <ul><a href="教室統計功能.php"><img class="img" src=""></img>教室統計</a></ul>
                <ul><a href="使用規則與管理辦法.php"><img class="img" src="https://cdn2.iconfinder.com/data/icons/legal-services-icostory-black-and-white/64/button-legal_document-list-goals-checklist-64.png"> 使用規則與管理辦法</img></a></ul>
