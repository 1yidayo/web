    ...
    <div class="wrapper">
        ...
        <div class="main">
            <div class="login_page">
                <div id="container1">
                    <div class="login">
                        <h1 style="text-align: center; margin-top: 30px; margin-bottom: 20px;">註冊 Register</h1>
                        <form id="login-form" style="margin: 30px;">
                            <input type="text" id="username" name="username" placeholder="帳號" required>
                            <div class="tab"></div>
                            <input type="password" id="password" name="password" placeholder="密碼" required>
                            <div class="tab"></div>
                            <input type="password" id="confirmPassword" name="confirmPassword" placeholder="確認密碼"
                                required> <!-- 修改這一行 -->
                            <div class="tab"></div>
                            <input type="button" value="確認註冊" class="submit" onclick="validateForm()">
                        </form>
                    </div>
                </div>
            ...
            <script>
                function validateForm() {
                    ...
                    var confirmPassword = document.getElementById('confirmPassword').value.trim(); // 取得確認密碼的值
                    ...
                    // 檢查欄位是否填寫
                    if (!username || !password || !confirmPassword) { // 添加確認密碼的檢查
                    ...
                    if (password !== confirmPassword) {
                        modalBody.textContent = '*密碼不一致*';
                        modalBody.classList.add('modal-error'); // 添加錯誤樣式
                        $('#messageModal').modal('show');
                        return false;
                    }

                    modalBody.textContent = '註冊成功';
