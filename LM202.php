...
<body>
    <div class="main">
        ...
        <div class="main">
            <h3 style="text-align: center;margin-top: 30px;">LM202</h3><br>
            <div class="alert1">
            ...
            <script>
                ...
                document.getElementById('cancel-reservation').addEventListener('click', function() {
                    if (confirm('確定要取消此預約嗎？')) {
                        ...
                        if (semesterId) {
                            ...
                            localStorage.setItem('events-instrument8', JSON.stringify(filteredEvents));
                ...
                function loadEventsFromLocalStorage() {
                    return JSON.parse(localStorage.getItem('events-instrument8')) || [];
                }

                function saveEventToLocalStorage(event) {
                    const events = loadEventsFromLocalStorage();
                    events.push(event);
                    localStorage.setItem('events-instrument8', JSON.stringify(events));
                }
